...
![DevCenter API Client ID View]({filename}/images/31-october-2018/APIClientIDs.png)
...
![Old Seller View]({filename}/images/31-october-2018/SellerOrg-OLD.png)
is now:
![New Seller View!]({filename}/images/31-october-2018/SellerOrganizations.png)
...
![Client ID View]({filename}/images/31-october-2018/APIClientIDs.png)
...
![DevCenter API Client ID View]({filename}/images/31-october-2018/UserAccessEdit.png)
...
![Multiple Commerce Roles]({filename}/images/31-october-2018/multiple-role-access.png)

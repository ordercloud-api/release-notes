...
This release consists of both a new API version, v1.0.85, and an update to our [DevCenter]() site. We are reorganizing our conception of what an 'application'
...
![]({}images/31-october-2018/APIClientIDs.png)
...
![]({}images/31-october-2018/SellerOrg-OLD.png)
is now:
![]({}images/31-october-2018/SellerOrganizations.png)
...
![]({}images/31-october-2018/UserAccessEdit.png)
...
![]({}images/31-october-2018/multiple-role-access.png)
...
This is mostly unimportant to people who aren't us. This upgrade provides reliability and security improvements to our Platform's .NET framework, among [other things](https://github.com/Microsoft/dotnet/blob/master/releases/net47/dotnet47-changes.md).
